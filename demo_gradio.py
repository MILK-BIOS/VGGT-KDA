...
local_ckpt_path = "ckpt/streamvggt.pth"
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        with gr.Column(scale=2):
            ...
            image_gallery = gr.Gallery(
                ...
                columns=4,
                height="300px",
                # show_download_button=True,  # removed: not supported in this Gradio version
                object_fit="contain",
                preview=True,
            )
    ...
    demo.queue(max_size=20).launch(show_error=True, share=True, theme=theme, css=_CUSTOM_CSS)