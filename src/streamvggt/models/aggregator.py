...
from streamvggt.layers.kda import KDABlock
...
class Aggregator(nn.Module):
            ...
            for attn_type in self.aa_order:
                if attn_type == "frame":
                    ...
                    if use_cache:
                        ...
                        tokens, global_idx, global_intermediates, new_cache = self._process_global_attention(
                        ...
                        past_key_values[global_idx - 1] = new_cache
                    else: 
    ...
    def _process_global_attention(
        ...
        for _ in range(self.aa_block_size):
            ...
            if use_cache:
                tokens, block_cache = self.global_blocks[global_idx](
                    tokens, 
                    attn_mask=attn_mask, 
                ...
                tokens = self.global_blocks[global_idx](tokens, attn_mask=attn_mask)
            global_idx += 1
            intermediates.append(tokens.reshape(B, S, P, C))
            ...
            #     del attn_mask
        if use_cache:
            return tokens, global_idx, intermediates, block_cache
