...
data_root = "/commondocument/fhs/datasets"
dataset_metadata = {
    "sun_rgbd": {
        "img_path": f"{data_root}/sun_rgbd/image/test",
        "mask_path": None,
    },
    "davis": {
        "img_path": f"{data_root}/davis/DAVIS/JPEGImages/480p",
        "mask_path": f"{data_root}/davis/DAVIS/masked_images/480p",
    ...
    "kitti": {
        "img_path": f"{data_root}/KITTI/depth_selection/val_selection_cropped/image_gathered",  # Default path
        "mask_path": None,
        "dir_path_func": lambda img_path, seq: os.path.join(img_path, seq),
        "gt_traj_func": lambda img_path, anno_path, seq: None,
        "traj_format": None,
    ...
    "nyu": {
        "img_path": f"{data_root}/nyu_v2/val/nyu_images",
        "mask_path": None,
        "process_func": lambda args, img_path: process_nyu(args, img_path),
    },
    "scannet": {
        "img_path": f"{data_root}/Scannetv2",
        "mask_path": None,
    ...
    "sintel": {
        "img_path": f"{data_root}/Sintel/training/final",
        "anno_path": f"{data_root}/Sintel/training/camdata_left",
        "mask_path": None,
        "dir_path_func": lambda img_path, seq: os.path.join(img_path, seq),
